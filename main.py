...
BufferSize=1000000 #Bytes to be received from a client (optional)
TimeLimitPerClient=60 #time in seconds
...
def work(client,addr):
	#modify this 
    send(client,"Welcome to online calculator \nTry typing into this calculator ex: 1+1 \nhttps://github.com/primaloptimum/pyserver.py:\n")
